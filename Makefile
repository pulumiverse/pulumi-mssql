SHELL            := /bin/bash
PROJECT          := github.com/pulumiverse/pulumi-mssql
NODE_MODULE_NAME := @pulumiverse/mssql
TF_NAME          := mssql
...
clean::
	rm -rf sdk/{dotnet,nodejs,go,python,java} bin

install_plugins::
	[ -x $(shell which pulumi) ] || curl -fsSL https://get.pulumi.com | sh
	pulumi plugin install resource random 4.3.1
	pulumi plugin install resource azuread 5.36.0
