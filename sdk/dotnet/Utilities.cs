...
namespace Pulumiverse.Mssql
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumiverse/pulumi-mssql";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Mssql.version.txt");
    ...
    internal sealed class MssqlResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public MssqlResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
