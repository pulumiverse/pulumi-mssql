...
namespace Pulumiverse.Mssql
{
    ...
    public partial class SchemaPermission : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public SchemaPermission(string name, SchemaPermissionArgs args, CustomResourceOptions? options = null)
            : base("mssql:index/schemaPermission:SchemaPermission", name, args ?? new SchemaPermissionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaPermission(string name, Input<string> id, SchemaPermissionState? state = null, CustomResourceOptions? options = null)
            : base("mssql:index/schemaPermission:SchemaPermission", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SchemaPermission Get(string name, Input<string> id, SchemaPermissionState? state = null, CustomResourceOptions? options = null)
        {
            return new SchemaPermission(name, id, state, options);
        }
    }

    public sealed class SchemaPermissionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of schema SQL permission. For full list of supported permissions, see [docs](https://learn.microsoft.com/en-us/sql/t-sql/statements/grant-schema-permissions-transact-sql?view=azuresqldb-current#remarks)
        /// </summary>
        ...
        public SchemaPermissionArgs()
        {
        }
        public static new SchemaPermissionArgs Empty => new SchemaPermissionArgs();
    }

    public sealed class SchemaPermissionState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Name of schema SQL permission. For full list of supported permissions, see [docs](https://learn.microsoft.com/en-us/sql/t-sql/statements/grant-schema-permissions-transact-sql?view=azuresqldb-current#remarks)
        /// </summary>
        ...
        public SchemaPermissionState()
        {
        }
        public static new SchemaPermissionState Empty => new SchemaPermissionState();
    }
}
