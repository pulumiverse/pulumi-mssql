...
__all__ = ['SchemaPermissionArgs', 'SchemaPermission']

@pulumi.input_type
class SchemaPermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] permission: Name of schema SQL permission. For full list of supported permissions, see [docs](https://learn.microsoft.com/en-us/sql/t-sql/statements/grant-schema-permissions-transact-sql?view=azuresqldb-current#remarks)
        ...
        :param pulumi.Input[str] schema_id: `<database_id>/<schema_id>`. Can be retrieved using `Schema`.
...
class SchemaPermission(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SchemaPermissionArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SchemaPermissionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SchemaPermissionArgs.__new__(SchemaPermissionArgs)
        ...
        super(SchemaPermission, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            principal_id: Optional[pulumi.Input[str]] = None,
            schema_id: Optional[pulumi.Input[str]] = None,
            with_grant_option: Optional[pulumi.Input[bool]] = None) -> 'SchemaPermission':
        """
        ...
        __props__ = _SchemaPermissionState.__new__(_SchemaPermissionState)

        __props__.__dict__["permission"] = permission
        __props__.__dict__["principal_id"] = principal_id
        __props__.__dict__["schema_id"] = schema_id
        __props__.__dict__["with_grant_option"] = with_grant_option
        return SchemaPermission(resource_name, opts=opts, __props__=__props__)
