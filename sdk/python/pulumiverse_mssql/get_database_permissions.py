...
__all__ = [
    'GetDatabasePermissionsResult',
    'AwaitableGetDatabasePermissionsResult',
    'get_database_permissions',
    'get_database_permissions_output',
]

@pulumi.output_type
class GetDatabasePermissionsResult:
    """
    ...
    @property
    @pulumi.getter
    def permissions(self) -> Sequence['outputs.GetDatabasePermissionsPermissionResult']:
        """
...
class AwaitableGetDatabasePermissionsResult(GetDatabasePermissionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDatabasePermissionsResult(
            id=self.id,
...
def get_database_permissions(principal_id: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabasePermissionsResult:
    """
...
def get_database_permissions_output(principal_id: Optional[pulumi.Input[str]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDatabasePermissionsResult]:
    """
    Returns all permissions granted in a DB to given principal
